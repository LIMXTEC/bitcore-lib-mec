 ...
 * @returns {URI} A new valid and fro megacoin instance of URI
 * @constructor
 */
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'mec:') {
    throw new TypeError('Invalid MEC URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid MEC address');
  }
